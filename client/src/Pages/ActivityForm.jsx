  ...
  return (
    <section className="w-full h-fit flex flex-col items-center justify-center gap-10">
      ...
      <form onChange={handleChange} onSubmit={handleSubmit} method="post" className="w-[60rem] flex flex-col items-center gap-3">
        ...
        <div className="w-full md:h-32 h-fit flex md:flex-row md:flex-wrap flex-col items-center justify-center ">
          ...
          <div className="w-1/3 h-full relative flex justify-center items-center gap-3 md:border-l-2 md:border-dashed border-[#6b6b6b] ">
